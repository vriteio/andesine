    ...
    <>
      <div
        class={clsx(
          ...
          props.color === "contrast" && "from-gray-100 to-gray-100/0",
          props.color !== "contrast" && "from-gray-50 to-gray-50/0",
